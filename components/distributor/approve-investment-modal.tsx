...
export function ApproveInvestmentModal({
  ...
  const handleApprove = async () => {
    ...
    // Validar se a data de pagamento não é maior que o momento atual
    ...
    if (selectedDate > now) {
      toast({
        ...
        description: "A data de pagamento não pode ser maior que o momento atual.",
        variant: "destructive"
      })
      return
    }
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <div className="text-sm space-y-1">
              ...
              <div><span className="font-medium">Valor:</span> {formatCurrency(investmentAmount)}</div>
            </div>
          </div>
