          ...
          <CardContent className="space-y-6">
            ...
            >
              {isProcessing
                ? "Processando..."
                : `Confirmar Resgate ${
                    withdrawType === "dividends_by_period" ? "Dividendos por Período" : "Retorno Mensal"
                  }`}
            </Button>
          </CardContent>
        </Card>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid gap-6">
        ...
        {/* Mensagem informativa de período */}
        <Card className="bg-gradient-to-b from-[#D9D9D9] to-[#003F28] border-0" style={{ borderRadius: '15px' }}>
          <CardHeader>
            <CardTitle className="text-[#003F28] font-urbanist font-extrabold text-[35px] leading-[28px]">Informação de Rendimentos</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            {!selectedInvestment && (
              <div className="bg-[#D9D9D9] p-4 rounded-lg" style={{ borderRadius: "15px" }}>
                <p className="text-[#003F28] font-ibm-plex-sans font-normal text-lg">
                  Selecione um investimento para visualizar a data de conclusão do período.
                </p>
              </div>
            )}
